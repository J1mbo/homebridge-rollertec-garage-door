...
# sends command to close the garage door.
...
logger "RollerTec (INFO) - toggling gpio 23 to request door CLOSE action"
gpio -g write 23 1 && sleep 0.5 && gpio -g write 23 0

# Update the status in /var/run
echo CLOSING > $STATUSFILE
